...
import { registerFormOwnerInputs } from "../../auth/register/form/registerFormOwnerInputs";
import { registerFormVetInputs } from "../../auth/register/form/registerFormVetInputs";
import { registerFormClinicOwnerInputs } from "../../auth/register/form/registerFormClinicOwnerInputs";
import { registerFormPlayerInputs } from "../../auth/register/form/registerFormPlayerInputs";
        ...
        <div className="auth-page-container">
          <div className="auth-form-container">
            ...
            <h2 className="text-center text-md">
              What type of user will you create?
            </h2>
